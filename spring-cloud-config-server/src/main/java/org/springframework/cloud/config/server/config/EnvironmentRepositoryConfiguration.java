...
import org.springframework.cloud.config.server.environment.MultiEnvironmentConfigurationManagerEnvironmentRepository;
...
@Import({ CompositeRepositoryConfiguration.class, JdbcRepositoryConfiguration.class, VaultConfiguration.class,
		VaultRepositoryConfiguration.class, CredhubConfiguration.class, CredhubRepositoryConfiguration.class,
		...
		MultiEnvironmentConfigurationManagerEnvironmentRepositoryConfiguration.class,
...
@Configuration
@Profile("configurationManager")
@ConditionalOnClass(MultiEnvironmentComponentConfigurationManager.class)
class MultiEnvironmentConfigurationManagerEnvironmentRepositoryConfiguration {

	@Bean
	public MultiEnvironmentConfigurationManagerEnvironmentRepository multiEnvironmentConfigurationManagerEnvironmentRepository() {
		return new MultiEnvironmentConfigurationManagerEnvironmentRepository();
	}
